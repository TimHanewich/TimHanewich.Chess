        ...
        public static Position UpRight(this Position position)
        {
            switch (position)
            {
                ...
                case Position.A1:
                    return Position.B2;
                default:
                    throw new Exception("An upward and rightward move is impossible from position " + position.ToString());
            }
        }
        ...
        public static Position UpLeft(this Position position)
        {
            switch (position)
            {
                ...
                case Position.H1:
                    return Position.G2;
                default:
                    throw new Exception("An upward leftward move is impossible from position " + position.ToString());
            }
        }
        ...
        public static Position DownLeft(this Position position)
        {
            switch (position)
            {
                ...
                case Position.H2:
                    return Position.G1;
                default:
                    throw new Exception("A downward leftward move is not possible from position " + position.ToString());
            }
        }
